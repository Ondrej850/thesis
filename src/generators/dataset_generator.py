...
class DatasetGenerator:
    ...
    def _augment_and_update_annotations(img, image_id: int,
        ...
        # Drop annotations where either dimension shrank below 70% of the
        # original. min_visibility filters by area, but a wide title row can
        # lose half its height yet still pass the area threshold while the text
